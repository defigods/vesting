...
interface ILotteryDao {
    ...
    event SetPrice(uint256 _poolId, uint256 _tokenPrice, uint256 _teamTokenPrice);
    ...
    event Lock(uint256 _poolId, address _token, uint256 _lock, uint256[] _percentages, uint256[] _vestingsPeriods);
