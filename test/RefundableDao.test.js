...
const SIGNER_KEY = 'ee8103cf924c1769938e39f33f17d76cf1b8adaf4f3eda6ac60b096036996db9';
var signer = '';
var quote = '';
...
contract('RefundableDao', async ([owner, user1, user2, user3, user4]) => {
  ...
  it("should recover signer from quote signature", async () => {
        ...
        let recoveredSigner = await refundableDao.recoverSigner(user1, quote, quoteSignature);
  ...
  describe('deposit', () => {
    ...
    it('should deposit correct amount', async () => {
      await refundableDao.deposit(0, wei('500'), quote, SIGNATURE, {from: user1});
